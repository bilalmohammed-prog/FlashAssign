...
export function TaskComments({
  ...
  const label = useMemo(() => `Comments (${commentCount})`, [commentCount]);
  ...
  return (
    <div className="relative space-y-2">
      <button
        ...
        className="group inline-flex w-fit max-w-full cursor-pointer items-center gap-2 rounded-md px-2 py-1 text-left text-xs font-medium text-zinc-500 transition-colors hover:bg-zinc-50 hover:text-zinc-800"
      ...
      >
        <div className="space-y-3 rounded-md border border-zinc-200 bg-white p-3">
          {loading ? (
            ...
            <div className="px-1 py-2 text-xs text-zinc-400">No comments yet</div>
          ) : (
