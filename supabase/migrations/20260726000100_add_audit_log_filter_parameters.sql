-- Add optional actor and date-range filtering without changing cursor semantics.

begin;

drop function if exists public.get_audit_logs(uuid, uuid, text, text, text, text, text, text, integer);
